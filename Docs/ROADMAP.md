...
- [x] 세션 종료 **인라인 장소 + 장식 미니맵**(`PlaceMiniMap`·GPS 자동채움) — 미니맵 탭→기존 리치 장소 화면(최근·지도·POI·사진, 무회귀) (dc6b3f3)
- [x] 진행률 바코드 데이터: 전체 페이지 수 **수동 입력**(카드 프롬프트) + **ISBN 보조 조회 자동 채움**(알라딘 1순위·Google Books 폴백) (c537a37·3d1d146, DECISIONS #17)
