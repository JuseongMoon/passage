...
- **상태**: ✅확정 — 홈(패스 스택)·세션 오버레이·책 추가 시트·화면 모드·삭제 확인 모달·3탭 재구성·문서 정합 완료(커밋 57668d4·c065551·9e0cde8·fa91a8e·52c70c0). 남은 **선택** 항목: 세션 종료 **인라인 장소 + 장식 미니맵**(현재 기존 `WhereDidYouReadView` 사용 — 회귀 위험으로 보류).
